...
#include "ToolBox.h"
#include "Robot.h"
#include <xc.h>//contient les pins
#include <math.h>
#include "QEI.h"    
...
void QEIUpdateData() {
    ...
    robotState.xPosFromOdometry = robotState.xPosFromOdometry_1 + robotState.vitesseDroitFromOdometry * cos(robotState.vitesseAngulaireFromOdometry * FREQ_ECH_QEI) * FREQ_ECH_QEI; //added
    robotState.yPosFromOdometry = robotState.yPosFromOdometry_1 + robotState.vitesseDroitFromOdometry * sin(robotState.vitesseAngulaireFromOdometry * FREQ_ECH_QEI) * FREQ_ECH_QEI; //added
